...
static const char *fonts[]          = {"Iosevka:style:medium:size=9", "Ac437 PhoenixVGA 9x14:size=12"};
...
static const int tagschemes[] = {
    SchemeTag1, SchemeTag2, SchemeTag4, SchemeTag5, SchemeTag3
};
...
static const Rule rules[] = {
    ...
    { "vivaldi-stable",  NULL,       NULL,       1 << 1,       0,           0,           0 },
    { "Vivaldi-stable",  NULL,       NULL,       1 << 1,       0,           0,           0 },
    { "discord",         NULL,       NULL,       1 << 2,       0,           0,           0 },
    { "eww",             NULL,       NULL,       0,            0,           1,           0 },
};
...
static const Key keys[] = {
    ...
    { MODKEY,                           XK_u,       spawn,            SHCMD("scrot") },

    { MODKEY,                           XK_p,       spawn,            SHCMD("rofi -config ~/Chadwm/rofi/config.rasi -show run") },
...
//    { MODKEY,                           XK_d,       incnmaster,     {.i = -1 } },
    ...
    { MODKEY|ShiftMask,                 XK_b,       movestack,      {.i = -1 } },
...
//    { MODKEY,                           XK_Tab,     view,           {0} },
    ...
    // kill dwm
    { MODKEY|ShiftMask,               XK_q,       spawn,        SHCMD("killall dwm-start.sh") },
